...
if (cupsOfFlour <= 1) {
  ...
  console.log('I do not have the ingredients to make a pizza');
}
...
for yourself!
Yes! My last exercise did use the AND logical operator. A logical operator in Java is an operator that returns a boolean result of one or two other expressions.
