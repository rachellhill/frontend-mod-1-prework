...
// because of the backticks and curly brackets, the sentece was created using interpolation to create that string mentioned above.
...
console.log(`My favorite animal is a ${mammal} and a ${reptile}.`);
